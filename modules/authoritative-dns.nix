...
let
  ...
  zones = {
    ...
    "antibuild.ing" = ''
      ...
      @ SOA ${(lib.head primaryServers).authoritativeDns.name}.antibuild.ing. lennart.zebre.us. 1710270000 14400 3600 604800 300
    ...
    "zebre.us" = ''
      ...
      @ IN SOA ns1.antibuild.ing. lennart.zebre.us. (
              1710270000  ; serial secs since Jan 1 1970
              14400        ; refresh (>=60)
              3600        ; retry (>=60)
              604800      ; expire
              300          ; minimum ttl
