...
8. Add the new host to the recipients of shared_wireguard_psk in secrets.nix. Then reencrypt the shared_wireguard_psk: `sudo geheimnix -i /etc/ssh/ssh_host_ed25519_key rekey shared_wireguard_psk`.
